...
public interface ShotMap {
        ...
        public interface Distances{
                ...
                double POINT_B = Units.inchesToMeters(176);
                double POINT_C = Units.inchesToMeters(184);
        ...
        Interpolator DISTANCE_TO_RPM =
                new NearestInterpolator(
                        ...
                        new Vector2D(Distances.POINT_C, 3200),
                        new Vector2D(Distances.POINT_D, 3200),
                        new Vector2D(Distances.POINT_E, 3200),
        ...
        Interpolator DISTANCE_TO_YAW =
                new NearestInterpolator(
                        ...
                        new Vector2D(Distances.POINT_C, 5.70),
                        new Vector2D(Distances.POINT_D, 5.70),
                        new Vector2D(Distances.POINT_E, 5.70),
