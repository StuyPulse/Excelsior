...
public class FiveBallRedAuton extends SequentialCommandGroup {
    ...
    private static final String FIVE_BALL_TO_SECOND_BALL = "FiveBallRedAuton/output/FiveBallAcquireSecondBall.wpilib.json";
    private static final String FIVE_BALL_TO_TERMINAL = "FiveBallRedAuton/output/FiveBallGetTerminalBalls.wpilib.json";
    private static final String FIVE_BALL_TERMINAL_TO_SHOOT = "FiveBallRedAuton/output/FiveBallShootTerminalBalls.wpilib.json";
    private static final String FIVE_BALL_TO_WALL_BALL = "FiveBallRedAuton/output/FiveBallGetWallBall.wpilib.json";

    /** Creates a new FiveBallAuton. */
    public FiveBallRedAuton(RobotContainer robot) {
