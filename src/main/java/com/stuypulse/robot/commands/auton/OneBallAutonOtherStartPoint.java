...
public class OneBallAutonOtherStartPoint extends SequentialCommandGroup {
    /* Creates a new OneBallAuton at other starting point */

    /*
    NOTE:
    The start point of this auton is in the left starting polygon.
    Robot should be placed as close to the intersection point between the
    two edges closest to the ring of balls as possible
    Angle should be facing the ball to intake.
    */
    ...
    private static final double DISTANCE_TO_RING = 1.0;

    public OneBallAutonOtherStartPoint(RobotContainer robot) {
